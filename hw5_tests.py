...
class TestCard(unittest.TestCase):
    ...
    def test_q4(self):
        ...
        '''
        eck = hw5_cards.Deck()
        self.assertEqual(len(eck.cards), 52)
        return len(eck.cards), 52  
    ...
    def test_q5(self):
        ...
        c1 = hw5_cards.Deck()
        c2 = c1.deal_card()
        self.assertIsInstance(c2, hw5_cards.Card)
        return c2, hw5_cards.Card
    ...
    def test_q6(self):
        ...
        c1 = hw5_cards.Deck()
        c1.deal_card()
        self.assertEqual(len(c1.cards), 51)
        return len(c1.cards), 51
    ...
    def test_q7(self):
        ...
        c2 = hw5_cards.Deck()
        c2.deal_card(i=-1)
        prev_num = len(c2.cards)
        c2.replace_card(card=(3,13))
        self.assertEqual(prev_num + 1, len(c2.cards), 52)
        return prev_num + 1, len(c2.cards), 52
